...
describe("Address Form", () => {
    ...
    it("Address Form: should be able to enter address in Google form", () => {
        let rendered = Renderer.create(<AddressForm {...props}/>).getInstance().wrappedInstance
        rendered.onAddressSelect("180 John Street, Toronto, Ontario, Canada m2j3j3", {address_components:[]})
